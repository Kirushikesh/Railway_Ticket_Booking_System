...
def book_train(train_no,day,t_class,fro,to,noofpass):
    ...
    file.close()
    return seat_no
print(seat_availability_onthatday(3,'Tuesday','3A',0,2))
#print(seat_availability(1,'2A',0,2))
#print(book_train(3,'Tuesday','3A_R',0,2,2))
#store_train_classes(1,"123",3,{'1A':5,'2A':4,'2A_R':2,'3A':4,'3A_R':2,'SL':5,'SL_R':3})
#store_train_classes(2,"147",2,{'1A':0,'2A':4,'2A_R':3,'3A':3,'3A_R':1,'SL':3,'SL_R':1})
##store_train_classes(3,"347",3,{'1A':5,'2A':6,'2A_R':4,'3A':2,'3A_R':1,'SL':0,'SL_R':0})